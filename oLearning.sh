...
start_udp=1                      # should I wait for a "start" udp message before (re)starting an episode?
episode_timeout=1                # should I end the episode if the takers do not pass the ball in a long time?
