...
taker_load=1                     # should I load previously learned weights?
...
taker_policy="learned!"       # policy followed by takers {learned, learned!, hand, hold, random} (BASELINE!!!!)
taker_mode="extracted"         # the real taker mode, the previous one only sets the baseline (see main.cc & the Analisys class)
