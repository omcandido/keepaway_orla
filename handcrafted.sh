...
taker_policy="handcrafted"       # policy followed by takers {learned, learned!, hand, hold, random} (BASELINE!!!!)
taker_mode="handcrafted"         # the real taker mode, the previous one only sets the baseline (see main.cc & the Analisys class)
